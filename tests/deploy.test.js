...
describe('Deploy endpoint', () => {
    ...
    it('verify metrics counters', async () => {
        const res = await request(app)
            .get('/metrics')
        expect(res.statusCode).toEqual(200)
        expect(res.text).toEqual('# HELP casperholders_operations Count operations\n# TYPE casperholders_operations counter\ncasperholders_operations{type=\"smart_contract_error\"} 2\ncasperholders_operations{type=\"add_bid\"} 1\ncasperholders_operations{type=\"withdraw_bid_error\"} 1\ncasperholders_operations{type=\"withdraw_bid\"} 1\ncasperholders_operations{type=\"delegate_error\"} 1\ncasperholders_operations{type=\"delegate\"} 1\ncasperholders_operations{type=\"undelegate_error\"} 1\ncasperholders_operations{type=\"undelegate\"} 1\ncasperholders_operations{type=\"transfer\"} 1\ncasperholders_operations{type=\"smart_contract\"} 1\n')
    })
})